  ...
  if (isAuthPage) {
    return (
      <header className="fixed top-0 left-0 w-full z-50">
        <div
          className={`bg-white/25 backdrop-blur-md 
            rounded-t-none rounded-b-[10px] 
            border border-white/20
            transform transition-all duration-500 ease-out
            ${mounted ? "translate-y-0 opacity-100" : "-translate-y-4 opacity-0"}`}
          style={{ boxShadow: "0 0 0 1px rgba(255,255,255,0.2) inset" }}
        >
          <div className="max-w-7xl mx-auto flex justify-center items-center px-4 sm:px-6 md:px-12 py-3 sm:py-4">
            <div className="flex items-center">
              <img src={ZennestLogo} alt="Zennest Logo" className="h-8 sm:h-10 w-auto" />
            </div>
          </div>
        </div>
      </header>
  ...
  return (
    <>
      <header className="fixed top-0 left-0 w-full z-50">
        <div
          className={`${
            isScrolled ? "bg-emerald-900/100" : "bg-white/15 backdrop-blur-sm"
          } 
            rounded-t-none rounded-b-[10px] 
            border border-white/20
            transform transition-all duration-500 ease-out
          ...
          <div className="max-w-7xl mx-auto flex justify-between items-center px-4 sm:px-6 md:px-12 py-3 sm:py-4">
            ...
            <div className="hidden md:flex items-center relative cursor-pointer" onClick={() => handleNavigation("/")}>
              <motion.img
                src={ZennestLogo}
                alt="Zennest Logo"
                className="h-8 sm:h-10 w-auto absolute"
                initial={{ opacity: 1 }}
            ...
            <div className="hidden md:block">
              {!user ? (
                <div className="flex items-center space-x-3">
                  ...
                  <button
                    className={`text-sm font-medium py-2 px-4 sm:px-5 rounded-lg transition ${
                      isScrolled
